                ...
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://cdn-icons-png.flaticon.com/128/3984/3984666.png'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">rinkimandal944@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span>Total Blog : </span>  07
                        </h2>
                                ...
                                <tbody>
                                    <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                        ...
                                        <th style={{ color: mode === 'dark' ? 'white' : 'black' }} scope="row" className="px-6 py-4 font-medium ">
                                            {/* thumbnail  */}
                                            <img className='w-16 rounded-lg' src={'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=2071&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} alt="thumbnail" />
                                        </th>
